...
<body>
  ...
  <main>
    <div id="hero">
      ...
      <a class="button" href="../showroom">Acceder au Showroom</a>
    </div>
        ...
        <?php foreach ($voitures as $voiture) { ?>
          <div class="card">
            ...
            <div class="wrapper">
              ...
              <a class="button" href="../car?id=<?php echo $voiture['id_voiture'] ?>">Voir plus</a>
            </div>
          </div>
        <?php } ?>
      </div>
    ...
    <section id="services">
      ...
      <div class="card-list">
        <?php
        if (empty($services)) {
          echo '<div class="empty">Aucun service</div>';
        } else {
